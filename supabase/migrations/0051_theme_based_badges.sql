...
-- ------------------------------------------------------------
-- 4. admin_upsert_badge() — p_level renamed to p_theme (same type
-- `text`, same position, so no signature change / no DROP needed).
-- Validates against the new 4-field theme vocabulary instead of the
-- old per-mission one.
-- ------------------------------------------------------------
